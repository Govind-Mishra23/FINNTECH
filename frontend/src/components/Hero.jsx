...
const Hero = ({ onApplyClick }) => {
  return (
    ...
    >
      {/* Subtle gradient overlay on left side only - reduced opacity */}
      <div className="absolute inset-0 bg-gradient-to-r from-gray-900/60 via-gray-900/25 to-transparent lg:via-gray-900/15"></div>
          ...
          <div className="text-center lg:text-left space-y-8 max-w-2xl">
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">
                ...
                <span className="text-white block text-2xl sm:text-3xl lg:text-4xl mt-2 font-semibold">
                  for Individuals & Businesses
                </span>
              </h1>
            </div>

            <p className="text-lg sm:text-xl text-white leading-relaxed max-w-xl font-medium">
              Partnered with leading banks to deliver end-to-end secured loan solutions.
              We simplify financing by offering optimal loan quantum with clarity, trust, and expertise.
            </p>
            ...
            <div className="pt-4">
              <button
                ...
                className="group relative bg-gray-800 text-white px-10 py-5 rounded-xl text-lg font-bold hover:bg-gray-900 transition-all duration-300 shadow-2xl hover:shadow-gray-500/50 hover:scale-105 transform"
              >
