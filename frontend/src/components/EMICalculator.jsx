      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-4 lg:gap-8">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6">
            ...
            <div className="mb-4 sm:mb-6">
              ...
              <input
                ...
                className="w-full h-2 bg-gradient-to-r from-gray-300 to-gray-600 rounded-lg appearance-none cursor-pointer slider"
              />
            </div>
              ...
              <div className="flex justify-between items-center mb-1 sm:mb-2">
                ...
                <div className="flex items-center gap-1 sm:gap-2">
                  ...
                  <select
                    ...
                    className="text-xs sm:text-sm font-semibold text-gray-800 bg-gray-100 border-0 rounded-lg px-1.5 sm:px-2 py-0.5 sm:py-1 cursor-pointer focus:ring-2 focus:ring-gray-500"
                  >
          ...
          <div className="space-y-3 sm:space-y-4">
            {/* EMI Card */}
            <div className="bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 text-white">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-4">
              <div className="bg-white rounded-lg sm:rounded-xl shadow p-3 sm:p-4 border-l-4 border-gray-600">
              ...
              <div className="bg-white rounded-lg sm:rounded-xl shadow p-3 sm:p-4 border-l-4 border-gray-400">
            ...
            {/* Total Payment Card */}
            <div className="bg-white rounded-lg sm:rounded-xl shadow p-3 sm:p-4 border-t-4 border-gray-700 flex justify-between items-center">
              <div>
                <div className="text-xs text-gray-600 mb-1">
                  Total Payment
                </div>
