...
const Services = ({ onApplyClick }) => {
  const financialServices = [
    ...
    },
    {
      ...
      subtitle: "Attractive rates, minimal docs, Higher loan Amount.",
    },
    {
      image: DebtConsolidationImg,
      title: "Debt Consolidation",
      subtitle: "Simplify repayments and reduce financial burden.",
    },
    {
    ...
    },
    {
      ...
      subtitle: "End-to-end construction project funding",
    },
  ];
          ...
          {financialServices.map((service, index) => (
            ...
            >
              ...
              <div className="relative h-64 sm:h-72 lg:h-80 overflow-hidden">
                ...
                {/* Gray shade overlay at bottom like reference image */}
                <div className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-gray-800/70 via-gray-700/40 to-transparent"></div>
