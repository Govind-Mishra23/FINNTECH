  ...
  return (
    <nav className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden border-b border-gray-200 py-2 flex justify-center items-center gap-2">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a
              href="tel:9844208555"
              className="flex items-center space-x-2 text-gray-500 hover:text-gray-900 px-3 py-2 text-sm font-medium transition-colors"
            >
          ...
          <div className="md:hidden flex items-center justify-between w-full">
            <a
              href="tel:9844208555"
              className="text-gray-800 hover:text-gray-900 text-sm font-medium flex items-center gap-1"
            >
