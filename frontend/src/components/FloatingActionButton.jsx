    ...
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
      ...
      <button
        ...
        style={{
          ...
          boxShadow: isHovered
            ? "0 25px 50px -12px rgba(55, 65, 81, 0.4), 0 0 30px rgba(107, 114, 128, 0.3)"
      ...
      >
        ...
        <div className="hidden md:flex items-center space-x-3 px-6 py-4">
          ...
          <div className="flex flex-col items-start">
            ...
            <span className="text-xs leading-tight text-gray-300">Get Loan</span>
          </div>
          <svg
        ...
        <div className="absolute inset-0 md:hidden rounded-2xl animate-pulse bg-gray-400/20"></div>
      </button>
    </div>
  );
};
